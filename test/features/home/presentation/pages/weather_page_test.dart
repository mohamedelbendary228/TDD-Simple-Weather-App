...
//* we will test 3 thing
// * 1 - The state of the page should change from [WeatherEmpty] to [WeatherLoading]
// *     when filling textField is finished
// * 2 - Display a progress indicator when the state of the page is [WeatherLoading]
// * 3 - Display a widget contains weather data when the state of the page is [WeatherLoaded]
...
void main() {
  ...
  testWidgets(
    ...
    (widgetTester) async {
      ...
      // Ensure all animations and timers have completed
